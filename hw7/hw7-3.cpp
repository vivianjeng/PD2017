...
int main() {
    ...
    for(int i=0;i<m;i++){
        ...
        for(int j=0;j<=strlen(price);j++){
            ...
            if(isdigit(price[j]) || price[j] == 45){ //input "isdigit" character or "negative sign"
        ...
        //determine the sum
        //if the interger part is zero, but the price is not equal to zero
